...
public class ComputerAppl {
    public static void main(String[] args) {
        ...
        double totalWorkingHours = getTotalWorkingHoursBatteryLaptop(shop);
        System.out.println("Total working hours battery of Laptop = " + totalWorkingHours);
        int totalSSDLaptopCapacity = getTotalSSDLaptopCapacity(shop);
        System.out.println("Total capacity ssd drives of Laptop = " + totalSSDLaptopCapacity);
    }
    ...
    public static double getTotalWorkingHoursBatteryLaptop(Computer[] arr) {
        double res = 0;
        for (int i = 0; i < arr.length; i++) {
